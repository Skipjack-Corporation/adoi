        ...
        public void onStateDidChange(String state) {
            ...
            switch (state) {
                case IMXCall.CALL_STATE_CREATED:
                    if (activeCall.isIncoming()) {
                        if (MatrixEventService.getInstance() != null) {
                            MatrixEventService.getInstance().launchIncomingCallNotification(activeCall.getRoom().getRoomDisplayName(BaseApplication.getContext()));
                        }
                        startRinging();
                    }
                    break;
                ...
                case IMXCall.CALL_STATE_CONNECTED:
                    if (MatrixEventService.getInstance() != null) {
                        MatrixEventService.getInstance().launchProgressCallNotification(
...
//                        mNotificationManager.cancel(MatrixEventService.SERVICE_CALL_ID);
//                    }catch (Exception e){}
                    break;
                }
            }
